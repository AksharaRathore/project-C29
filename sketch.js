...
function setup() {
  ...
  leftWall = new Base(1, height / 2 + 50, 250, 100, "#8d6e63", true);
  rightWall = new Base(width - 1, height / 2 + 50, 250, 100, "#8d6e63", true);

  /*bridge = new Base(15, { x: width / 2 - 400, y: height / 2 });
  jointPoint = new Base(width - 600, height / 2 + 10, 40, 20, "#8d6e63", true);*/

  bridge = new Bridge(20, { x: width / 2 - 700, y: height / 2 });


  jointPoint = new Base(width - 100, height / 2 + 10, 40, 60, "#284256", true);
